	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'focus-ring': {
					'0%': { boxShadow: '0 0 0 0 hsl(var(--focus) / 0.4)' },
					'100%': { boxShadow: '0 0 0 4px hsl(var(--focus) / 0.4)' }
				}
			},
			animation: {
				...
				'slide-left': 'slide-left var(--transition-normal) ease-out',
				'focus-ring': 'focus-ring var(--transition-fast) ease-out'
			},
			backgroundImage: {
